        ...
        return () => {
            ...
            spawnBosses(census);
                ...
                if (bots.length < c.BOTS) {
                    ...
                    o.color = 17;
                    o.define(Class.bot);
                       let arrayOfClasses = [Class.spike, Class.stream, Class.overseer, Class.weirdspike, Class.fallen_booster,
                                        Class.machinegunner, Class.penta, Class.octo, Class.uh, Class.fallenoverlord,
                                        Class.hybrid, Class.anni, Class.destroy, Class.booster, Class.mega_anni, ]                  
