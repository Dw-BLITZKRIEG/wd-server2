...
var maintainloop = (() => {
    ...
    let spawnBosses = (() => {
        ...
        return census => {
            if (timer > 6000 && ran.dice(1500 - timer)) {
                util.log('[SPAWN] Preparing to spawn...');
                timer = 0;
                let choice = [];
                switch (ran.chooseChance(40, 1)) {
                    case 0: 
                        choice = [[Class.elite_destroyer, Class.elite_gunner, Class.summoner_ai, Class.fallenoverlord_ai, Class.fallen_booster_ai], 2, 'a', 'nest'];
                        break;
                    case 0: 
    ...
    let spawnCrasher = census => {
        if (ran.chance(1 -  0.5 * census.crasher / room.maxFood / room.nestFoodAmount)) {
            ...
            let type = (ran.dice(1)) ? ran.choose([Class.crasher2, Class.sentryGun, Class.sentrySwarm, Class.sentryTrap, Class.crasher2]) : Class.crasher;
            let o = new Entity(spot);
                o.define(type);
        }
    };
    ...
    let makenpcs = (() => {
         //Make base protectors if needed.
            let f = (loc, team) => { 
                ...
                o.define(Class.dominator02, Class.dominator02, Class.dominator02);
                    o.team = -team;
